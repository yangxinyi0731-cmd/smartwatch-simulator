...
当前状态更新（2026-08-29）：官方 6.90 GB 大文件下载中断后，只从前缀恢复出 48 个逐成员通过解压长度与 CRC-32 核验的参与者文件；按固定目录顺序选择 24 人训练、12 人不重叠评估，已训练并登记活动 ONNX。评估 3,728 个窗口，准确率 0.6075643776824035、宏平均 F1 0.5977935900949525；这只是恢复子集内参与者留出结果，不是完整 151 人、老人专项或外部验证，`deployment_approved=false`。
